...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="", type=str, help="sbert or prop")
    parser.add_argument("--max_sequence_length", default=256, type=int, help="sbert or prop")
    parser.add_argument("--input_file", default="", type=str, help="input file with raw text")
    parser.add_argument("--output_file", default="", type=str, help="output file save embeddings")
