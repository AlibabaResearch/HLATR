...
parser.add_argument("--qrels_file", type=str, default="", help="qrels file")
parser.add_argument("--query_file", type=str, default="", help="query file")
parser.add_argument('--collection_file', type=str, default="", help="collections file")
parser.add_argument("--save_to", type=str, default="", help="processd train json file")
