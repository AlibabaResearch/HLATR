...
class ModelArguments:
    ...
    relabel: Optional[bool] = field(default=True)
    hidden_size: Optional[int] = field(default=256)
    num_hidden_layers: Optional[int] = field(default=6)
    num_attention_heads: Optional[int] = field(default=8)
    emb_size: Optional[int] = field(default=768)
...
class DataArguments:
    ...
    dev_id_file: str = field(default=None,metadata={"help": "Path to dev id file"})
    ...
    run_id: str = field(
        default="deepct1",metadata={"help":"run id"}
    )
    rank_score_path: str = field(default=None, metadata={"help": "where to save the match score"})
    output_emb: bool = field(default=False,metadata={"help": "Whether to output emb"})
    max_len: int = field(
        default=128,
        metadata={
...
class RerankerTrainingArguments(TrainingArguments):
    ...
    continue_train_checkpoint: str = field(default=None,metadata={"help":"continue train"})
