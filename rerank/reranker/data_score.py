...
class GroupedTrainDataset(Dataset):
    ...
    document_columns = ['pid', 'passage','score']
    ...
    def create_one_example(self, qry_encoding: List[int], doc_encoding: List[int], score: float):
    ...
    def __getitem__(self, item) -> List[BatchEncoding]:
        ...
        examples.append((qry, pos_psg, pos_score))
        group['neg'] = group['neg']
        ...
        for neg_entry in negs:
            _, neg_psg , neg_score = [neg_entry[k] for k in self.document_columns]
            examples.append((qry, neg_psg, neg_score))
