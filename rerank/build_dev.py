...
if __name__ == "__main__":
    ...
    parser.add_argument('--truncate', type=int, default=256, help="")
    parser.add_argument('--qrel_file', type=str, default="", help="qrels train file")
    parser.add_argument('--query_file', type=str, default="", help="query train file")
    parser.add_argument('--corpus_file', type=str, default="", help="corpus file")
    parser.add_argument('--topk', type=int, default=1000, help="select topk result")
    parser.add_argument('--retrieval_file', type=str, default="", help="train query retrieval result")
    parser.add_argument('--ranking_file', type=str, default="", help="ranking train save file")
    parser.add_argument('--label_file', type=str, default="", help="ranking train save file")
